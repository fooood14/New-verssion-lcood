    ...
    <div className="min-h-screen px-4 py-6">
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2">اختر الاختبار الذي تريد المشاركة فيه</h2>
          <p className="text-slate-400 text-sm sm:text-base">جميع الاختبارات متاحة للمشاركة المباشرة</p>
        </div>
              ...
              >
                <Card className="h-full bg-gradient-to-br from-slate-800/80 to-slate-900/80 border-slate-700 text-white hover:border-blue-500/50 transition-all duration-300 backdrop-blur-sm shadow-lg hover:shadow-xl">
                    ...
                    <div className="p-4 pb-0">
                      <div className="rounded-lg overflow-hidden">
                        <img
                          src={exam.image_url}
                          alt={exam.title}
                          className="w-full h-40 object-cover sm:h-32 md:h-40 rounded-md"
                  ...
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg sm:text-xl font-bold text-center mb-2 text-blue-300">
                      {exam.title}
                    </CardTitle>
                    {exam.description && (
                      <p className="text-sm sm:text-base text-slate-400 text-center line-clamp-2">
                        {exam.description}
                      </p>
                    )}
                  </CardHeader>
